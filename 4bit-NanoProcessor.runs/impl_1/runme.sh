...
HD_PWD='D:/UOM/Semester 2/Computer Organization and Digital Design/Labs/Lab9/4bit-NanoProcessor/4bit-NanoProcessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg_Bank.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Reg_Bank.tcl -notrace
